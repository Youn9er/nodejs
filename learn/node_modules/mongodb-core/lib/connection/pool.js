...
const MongoNetworkError = require('mongodb-core/lib/error').MongoNetworkError;
const MongoWriteConcernError = require('mongodb-core/lib/error').MongoWriteConcernError;
const Logger = require('mongodb-core/lib/connection/logger');
const f = require('util').format;
const Msg = require('mongodb-core/lib/connection/msg').Msg;
const CommandResult = require('mongodb-core/lib/connection/command_result');
const MESSAGE_HEADER_SIZE = require('mongodb-core/lib/wireprotocol/shared').MESSAGE_HEADER_SIZE;
const COMPRESSION_DETAILS_SIZE = require('mongodb-core/lib/wireprotocol/shared').COMPRESSION_DETAILS_SIZE;
const opcodes = require('mongodb-core/lib/wireprotocol/shared').opcodes;
const compress = require('mongodb-core/lib/wireprotocol/compression').compress;
const compressorIDs = require('mongodb-core/lib/wireprotocol/compression').compressorIDs;
const uncompressibleCommands = require('mongodb-core/lib/wireprotocol/compression').uncompressibleCommands;
const apm = require('mongodb-core/lib/connection/apm');
const Buffer = require('safe-buffer').Buffer;
const connect = require('mongodb-core/lib/connection/connect');
const updateSessionFromResponse = require('mongodb-core/lib/sessions').updateSessionFromResponse;
