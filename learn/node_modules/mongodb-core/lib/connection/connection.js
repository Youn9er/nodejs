...
const parseHeader = require('mongodb-core/lib/wireprotocol/shared').parseHeader;
const decompress = require('mongodb-core/lib/wireprotocol/compression').decompress;
const Response = require('mongodb-core/lib/connection/commands').Response;
const BinMsg = require('mongodb-core/lib/connection/msg').BinMsg;
...
const OP_COMPRESSED = require('mongodb-core/lib/wireprotocol/shared').opcodes.OP_COMPRESSED;
const OP_MSG = require('mongodb-core/lib/wireprotocol/shared').opcodes.OP_MSG;
