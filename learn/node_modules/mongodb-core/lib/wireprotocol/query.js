...
const Query = require('mongodb-core/lib/connection/commands').Query;
const MongoError = require('mongodb-core/lib/error').MongoError;
const getReadPreference = require('mongodb-core/lib/wireprotocol/shared').getReadPreference;
const collectionNamespace = require('mongodb-core/lib/wireprotocol/shared').collectionNamespace;
const isSharded = require('mongodb-core/lib/wireprotocol/shared').isSharded;
const maxWireVersion = require('mongodb-core/lib/utils').maxWireVersion;
const applyCommonQueryOptions = require('mongodb-core/lib/wireprotocol/shared').applyCommonQueryOptions;
const command = require('mongodb-core/lib/wireprotocol/command');
