...
var inherits = require('util').inherits,
  ...
  debugOptions = require('mongodb-core/lib/connection/utils').debugOptions,
  retrieveBSON = require('mongodb-core/lib/connection/utils').retrieveBSON,
  Pool = require('mongodb-core/lib/connection/pool'),
  MongoError = require('mongodb-core/lib/error').MongoError,
  MongoNetworkError = require('mongodb-core/lib/error').MongoNetworkError,
  wireProtocol = require('mongodb-core/lib/wireprotocol'),
  BasicCursor = require('mongodb-core/lib/cursor'),
  sdam = require('mongodb-core/lib/topologies/shared'),
  createClientInfo = require('mongodb-core/lib/topologies/shared').createClientInfo,
  createCompressionInfo = require('mongodb-core/lib/topologies/shared').createCompressionInfo,
  resolveClusterTime = require('mongodb-core/lib/topologies/shared').resolveClusterTime,
  SessionMixins = require('mongodb-core/lib/topologies/shared').SessionMixins,
  relayEvents = require('mongodb-core/lib/utils').relayEvents;
