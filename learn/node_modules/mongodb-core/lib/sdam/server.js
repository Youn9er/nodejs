...
const Pool = require('mongodb-core/lib/connection/pool');
const relayEvents = require('mongodb-core/lib/utils').relayEvents;
const wireProtocol = require('mongodb-core/lib/wireprotocol');
...
const monitorServer = require('mongodb-core/lib/sdam/monitoring').monitorServer;
...
const collationNotSupported = require('mongodb-core/lib/utils').collationNotSupported;
const debugOptions = require('mongodb-core/lib/connection/utils').debugOptions;
