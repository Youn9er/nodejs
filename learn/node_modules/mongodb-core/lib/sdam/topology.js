...
const ServerDescription = require('mongodb-core/lib/sdam/server_description').ServerDescription;
const ServerType = require('mongodb-core/lib/sdam/server_description').ServerType;
const TopologyDescription = require('mongodb-core/lib/sdam/topology_description').TopologyDescription;
const TopologyType = require('mongodb-core/lib/sdam/topology_description').TopologyType;
const monitoring = require('mongodb-core/lib/sdam/monitoring');
const calculateDurationInMs = require('mongodb-core/lib/utils').calculateDurationInMs;
const MongoTimeoutError = require('mongodb-core/lib/error').MongoTimeoutError;
const Server = require('mongodb-core/lib/sdam/server');
const relayEvents = require('mongodb-core/lib/utils').relayEvents;
const ReadPreference = require('mongodb-core/lib/topologies/read_preference');
const readPreferenceServerSelector = require('mongodb-core/lib/sdam/server_selectors').readPreferenceServerSelector;
const writableServerSelector = require('mongodb-core/lib/sdam/server_selectors').writableServerSelector;
const isRetryableWritesSupported = require('mongodb-core/lib/topologies/shared').isRetryableWritesSupported;
const Cursor = require('mongodb-core/lib/cursor');
const deprecate = require('util').deprecate;
const BSON = require('mongodb-core/lib/connection/utils').retrieveBSON();
const createCompressionInfo = require('mongodb-core/lib/topologies/shared').createCompressionInfo;
const isRetryableError = require('mongodb-core/lib/error').isRetryableError;
const MongoParseError = require('mongodb-core/lib/error').MongoParseError;
const ClientSession = require('mongodb-core/lib/sessions').ClientSession;
const createClientInfo = require('mongodb-core/lib/topologies/shared').createClientInfo;
const MongoError = require('mongodb-core/lib/error').MongoError;
const resolveClusterTime = require('mongodb-core/lib/topologies/shared').resolveClusterTime;
