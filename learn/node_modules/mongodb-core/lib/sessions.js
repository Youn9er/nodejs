...
const uuidV4 = require('mongodb-core/lib/utils').uuidV4;
...
const Transaction = require('mongodb-core/lib/transactions').Transaction;
const TxnState = require('mongodb-core/lib/transactions').TxnState;
const isPromiseLike = require('mongodb-core/lib/utils').isPromiseLike;
const ReadPreference = require('mongodb-core/lib/topologies/read_preference');
const isTransactionCommand = require('mongodb-core/lib/transactions').isTransactionCommand;
